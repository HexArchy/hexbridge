...
Отправитель повторяет только перечисленное. Список ограничен 256 номерами: если
дырок больше, отправитель начинает заново с первого недостающего — на таком
качестве связи выборочный повтор всё равно не выигрывает.
